...
public class MainActivity2 extends AppCompatActivity {
    ...
    private void displayAudioSongsName()
    {
        ...
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(MainActivity2.this, android.R.layout.simple_list_item_1,AllItems);
        ...
        SongsList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id)
            {
                ...
                Intent iobj = new Intent(MainActivity2.this,MainActivity.class);
                iobj.putExtra("song", audioSongs);
                iobj.putExtra("name",songName);
                iobj.putExtra("position", position);
                startActivity(iobj);
